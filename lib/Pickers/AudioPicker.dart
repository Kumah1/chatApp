...
class AudioPicker extends StatefulWidget {
  AudioPicker({Key? key, @required this.title, @required this.callback})
      : super(key: key);

  final String? title;
  final Function? callback;
  @override
  _AudioPickerState createState() => new _AudioPickerState();
}
...
class _AudioPickerState extends State<AudioPicker> {
  ...
  void initState() {
    super.initState();
    _extension = "mp3, wav, wma, aac,flac, ogg, amr, opus";
  }
