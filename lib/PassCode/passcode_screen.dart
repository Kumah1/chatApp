...
import 'package:kumchat/PassCode/circle.dart';
import 'package:kumchat/PassCode/keyboard.dart';
import 'package:kumchat/PassCode/shake_curve.dart';
...
class _PasscodeScreenState extends State<PasscodeScreen>
  ...
  int passcodeTries = 0, answerTries = 0;
  ...
  bool forgetActionable() {
    ...
    return (tries <= TRIES_THRESHOLD ||
        DateTime.now().isAfter(lastTried.add(Duration(
            minutes: math.pow(TIME_BASE, tries - TRIES_THRESHOLD) as int))));
  }
  ...
  void initState() {
    ...
    animation = Tween(begin: 0.0, end: 10.0).animate(curve.value)
